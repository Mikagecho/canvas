...
export const scenarioData: Record<string, ScenarioNode> = {
    ...
    'node_001': {
        ...
        backgroundId: '/images/bg/bg_car_interior_rain1.png',
        seId: 'se_heavy_rain',
        next: 'node_002',
    },
    'node_002': {
    ...
    'node_008': {
        ...
        backgroundId: '/images/bg/bg_forest_mansion_distant.png',
        seId: 'se_thunder',
        effect: 'flash',
        next: 'node_009',
    },
    ...
    'node_enter_gate': {
        ...
        backgroundId: '/images/bg/bg_mansion_gate_open.png',
        seId: 'se_gate_open',
    ...
    'node_mansion_entrance': {
        ...
        text: '玄関ホールは静まり返っていた。\n古びた洋館特有の、黴臭い匂いが鼻をつく。\n「誰も……いないみたいだね」',
        backgroundId: '/images/bg/bg_mansion_hall.png',
        next: 'node_find_doll',
    },
    'node_find_doll': {
        id: 'node_find_doll',
    ...
    'node_explore_start': {
        ...
        backgroundId: '/images/bg/bg_corridor.png',
    ...
    'node_dining_room': {
        ...
        backgroundId: '/images/bg/bg_dining.png',
        next: 'node_dining_rot'
    },
    'node_dining_rot': {
        id: 'node_dining_rot',
        text: 'よく見ると、それらは全て腐り落ちていた。\n皿からはみ出した植物の根が、肉や魚を苗床にして脈打っている。',
        backgroundId: '/images/bg/bg_dining_rot.png',
        effect: 'glitch',
    ...
    'node_merge_explore': {
        ...
        backgroundId: '/images/bg/bg_corridor_vines.png',
    ...
    'node_search_scream': {
        ...
        text: '『きゃあああああ！！』\n館の奥から、彼女の悲鳴が響いた。\n僕は弾かれたように走り出した。',
        backgroundId: '/images/bg/bg_corridor_run.png',
        seId: 'se_scream',
        effect: 'shake',
    ...
    'node_partner_truth': {
        ...
        backgroundId: '/images/bg/bg_basement_flowers_horror.png',
        effect: 'flash',
        seId: 'se_shock',
    ...
    'node_bad_end_1': {
        ...
        backgroundId: '/images/bg/bg_red_out.png',
        next: 'node_game_over_bad'
    },
    'node_game_over_bad': {
        id: 'node_game_over_bad',
        text: '【BAD END 1：肥料】',
        // backgroundId: '/images/bg/bg_black.png', // Assuming standard black ending or keep red? Keeping consistency with prev
        backgroundId: '/images/bg/bg_black.png',
    },
    ...
    'node_normal_end_run': {
        ...
        backgroundId: '/images/bg/bg_corridor_run.png', // Reusing run image
        next: 'node_escape_outside'
    },
    'node_escape_outside': {
        id: 'node_escape_outside',
        text: '雨の中、泥だらけになりながら山道を転がり落ちる。\n気がつくと、夜が明け始めていた。\n館はもう、どこにも見当たらなかった。',
        backgroundId: '/images/bg/bg_morning_forest.png',
    ...
    'node_game_over_normal': {
        ...
        backgroundId: '/images/bg/bg_white.png', // Or black, let's go with white for normal/morning end? Request had black/white.
    },
    ...
    'node_true_end_burn': {
        ...
        backgroundId: '/images/bg/bg_fire.png',
        seId: 'se_burn',
    ...
    'node_true_end_final': {
        ...
        backgroundId: '/images/bg/bg_morning_sun.png',
        next: 'node_game_over_true'
    },
    'node_game_over_true': {
        id: 'node_game_over_true',
        text: '【TRUE END：彼岸の夜明け】',
        backgroundId: '/images/bg/bg_white.png',
    },
    ...
    'node_gag_hall_dark': {
        ...
        backgroundId: '/images/bg/node_gag_hall_dark.png',
        seId: 'se_ambient_horror',
    ...
    'node_gag_jump_scare': {
        ...
        backgroundId: '/images/bg/node_gag_jump_scare.png',
        effect: 'shake',
        seId: 'se_shock',
    ...
    'node_gag_reveal': {
        ...
        backgroundId: '/images/bg/node_gag_reveal.png',
        effect: 'flash',
    ...
    'node_gag_flashmob': {
        ...
        backgroundId: '/images/bg/node_gag_flashmob.png',
        next: 'node_gag_end'
    },
    'node_gag_end': {
        id: 'node_gag_end',
